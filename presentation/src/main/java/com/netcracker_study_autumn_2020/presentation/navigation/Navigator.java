...
import com.netcracker_study_autumn_2020.presentation.ui.activity.PhotosActivity;
...
public class Navigator {
    ...
    public void navigateToPhotosActivity(Context context, WorkspaceModel workspaceModel){
        context.startActivity(PhotosActivity.getCallingIntent(context, workspaceModel));
    }
